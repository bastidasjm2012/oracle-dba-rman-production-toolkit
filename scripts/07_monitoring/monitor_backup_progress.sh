#!/bin/bash
# =============================================================================
# Script Name : monitor_backup_progress.sh
# Description : Oracle RMAN Backup Progress Monitoring Wrapper
...
sqlplus -s / as sysdba @"$(dirname "$0")/monitor_backup_progress.sql"
