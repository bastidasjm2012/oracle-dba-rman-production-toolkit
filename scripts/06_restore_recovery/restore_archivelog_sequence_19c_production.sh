#!/bin/bash
# =============================================================================
# Script Name : restore_archivelog_sequence_19c_production.sh
# Description : Oracle RMAN Archivelog Restore Wrapper
...
LOG_FILE="${LOG_DIR}/restore_arch_${DATE_TAG}.log"

RMAN_SCRIPT="$(dirname "$0")/restore_archivelog_sequence_19c_production.rman"
